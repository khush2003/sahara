...
class Help extends StatelessWidget {
  ...
  void navigateToTopic(BuildContext context, String topic) {
    if (topic == 'How to donate used item?') {
      Navigator.push(
        context,
        MaterialPageRoute(builder: (context) => const HowToDonateUsedItem()),
      );
    } else if (topic == 'How to measure your item?') {
      Navigator.push(
        context,
        MaterialPageRoute(builder: (context) => const HowToMeasureYourItem()),
      );
    } else if (topic == 'How to pay delivery fee?') {
      Navigator.push(
        context,
        MaterialPageRoute(builder: (context) => const HowToPayDeliveryFee()),
      );
    }
  }
